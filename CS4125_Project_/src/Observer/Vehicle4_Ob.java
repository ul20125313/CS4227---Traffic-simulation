...
public class Vehicle4_Ob implements Observer{// this is one of observer classes that implements observer interface
	...
	public Vehicle4_Ob(Subject Speed_monitor)//constructor class
	{
	...
	public double Vehicle4_speed()
	{
		return this.speeds.get(3);
	}
	
	public String Vehicle4_drivernames()
	{
		return this.drivernames.get(3);
	}
	public String Vehicle4_carnames()
	{
		return this.carNames.get(3);
	}
	public String Vehicle4_driverTempers()
	{
