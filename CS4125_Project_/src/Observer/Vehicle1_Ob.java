...
public class Vehicle1_Ob implements Observer{// this is one of observer classes that implements observer interface
	...
	public Vehicle1_Ob(Subject Speed_monitor)//constructor class
	{
	...
	public double Vehicle1_speed()
	{
		return this.speeds.get(0);
	}
	
	public String Vehicle1_drivernames()
	{
		return this.drivernames.get(0);
	}
	public String Vehicle1_carnames()
	{
		return this.carNames.get(0);
	}
	public String Vehicle1_driverTempers()
	{
