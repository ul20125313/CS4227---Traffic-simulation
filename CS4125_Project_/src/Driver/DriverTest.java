...
//	
//	private IrritableDriver IrritableDr = new IrritableDriver("Tom", new Vehicle(), "Irritable", balance);
//	private NormalDriver NormalDr = new NormalDriver("J.J", new Vehicle(), "Normal", balance);
//	
//	@Before
