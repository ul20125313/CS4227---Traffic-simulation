...
public class DriverTest {//This class can be used to test the function in the driver class
	...
	private IrritableDriver IrritableDr = new IrritableDriver("Tom", new Vehicle(), "Irritable", 1);
	private NormalDriver NormalDr = new NormalDriver("J.J", new Vehicle(), "Normal", 2);
